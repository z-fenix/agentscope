...
public class JsonSchemaUtils {
  ...
  /**
   * Generate JSON Schema from a Java class. This method is suitable for structured output scenarios
   * where complex nested objects need to be converted to JSON Schema format.
   *
   * @param clazz The class to generate schema for
   * @return JSON Schema as a Map
   * @throws RuntimeException if schema generation fails due to reflection errors, configuration
   *                          issues, or other processing errors
   */
  ...
  /**
   * Generate JSON Schema from a tools.jackson.databind.JsonNode instance. This method is suitable
   * for structured output scenarios where complex nested objects need to be converted to JSON
   * Schema format.
   *
   ...
   * @throws RuntimeException      if the conversion fails due to type mismatch, JSON parsing
   *                               errors, or incompatible data structure
   */
